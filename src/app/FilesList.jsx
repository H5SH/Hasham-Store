...
const files = [
  ...
  {name: 'Match', size: '11 MB', type: '.love', details: 'A board styled game with challenges like no swap if no match, with 18 different colors of brick and different boxes with different points and row and colum clear a match bigger then 3', url: 'files/Match.love', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv4ofY-vh_76P95AY92FFWMdS9ZpvSZNGhxw&s', style: {color: 'white'}},
  {name: 'Mario', size: '17 MB', type: '.love', details: 'A Replica of super mario brothers created in love2d catching the key is ensential to progress to the next level falling or hitting the snakes result in game over', url: 'files/mario.love', logo: 'https://i.ytimg.com/vi/U3_DwwsFlJI/maxresdefault.jpg', style: {color: 'white'}},
  {name: 'Zelda', size: '810 kb', type: '.love', details: 'Fallowing the old games theme zelda created in lua and love2d', url: 'files/zelda.love', logo: 'https://i.ytimg.com/vi/6JHZv5Vl5ks/maxresdefault.jpg', style: {color: 'white'}}
