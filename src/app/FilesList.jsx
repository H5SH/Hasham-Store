...
const files = [
  ...
  { name: 'ChildrenCare', size: '723 MB', type: '.apk', details: 'Android App created in React Native, A guide on tracheostomy care in children', url: '/files/childrenCare.apk', logo: '/logos/trachealLogo.jpg' },
